...
#%%
rates_exp = ascii.read('fluences.csv')
r = rates_exp['Distance']

plt.figure(figsize = (10,15))

plt.subplot(311)
plt.loglog(rates_exp['Fluence of Supernovae'], rates_exp['Distance'], color = 'b')
plt.title('Fluence of Supernovae vs Distance')
plt.xlabel('Fluence (erg/pc^2)')
plt.ylabel('Distances (pc)')

plt.subplot(312)
plt.loglog(rates_exp['Fluence of LGRB'], rates_exp['Distance'], color = 'g')
plt.title('Fluence of LGRB vs Distance')
plt.xlabel('Fluence (erg/pc^2)')
plt.ylabel('Distances (pc)')

plt.subplot(313)
plt.loglog(rates_exp['Fluence of SGRB'], rates_exp['Distance'], color = 'r')
